...
const BLOG = {
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 2008, // e.g if leave this empty, current year will be used.
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://nb.cxczhp.pp.ua', // 网站地址
